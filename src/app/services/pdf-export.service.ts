...
export class PdfExportService {
    ...
    exportPDFFile() {
        ...
        const docDefinition = {
            ...
            footer: {
                columns: [
                    { text: 'Left part', alignment: 'left', padding: [50, 50, 50, 50] },
                    { text: 'Center part', alignment: 'center', padding: [0, 50, 50, 50] },
                    { text: 'Right part', alignment: 'right', padding: [0, 50, 50, 0] }
                ],
                columnGap: 10
            },
            content: [
